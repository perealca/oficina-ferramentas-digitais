...
Neste repósitorio você irá encontrar conteúdos acerca de uma oficina realizada no [Uninta](https://www.uninta.edu.br/) da qual foram realizados o uso de algumas ferramentas digitais **(EXPOSTAS LOGO ABAIXO)** e apresentadas algumas considerações acerca de temas como computação e as eventuais relações daqueles que realizaram o projeto com a mesma.  
...
Para acessar o material é muito simples, basta baixar os arquivos aqui mesmo no GitHub e posteriormemte acessar os arquivos pelo seu computador **(CASO VOCÊ TENHA ACESSO AO PACOTE OFFICE)** ou você pode fazer o upload dos arquivos via [Google Drive](https://drive.google.com/drive) para ter uma melhor experiência na visualização do mesmo **(CASO OPITE POR VER EM SEU COMPUTADOR, BAIXE O PDF DO ARQUIVO DE TEXTO AO INVÉS DO DOCX)**. Além disso você pode acessar este [link](https://drive.google.com/drive/folders/1F2hoW6Y2kbgDg2G8b0hXDVdw6zmtVuaA?usp=drive_link), que lhe dará acesso ao material diretamente no própio Google Drive **(RECOMENDADO)**.
